...
# Tópico para receber todos os dados do joystick
MQTT_TOPIC_SUBSCRIBE = "joystick/#"

# --- Configuração do Firestore ---
db = firestore.Client()

# IMPORTANTE: Usamos um novo documento para não misturar com o projeto anterior.
FIRESTORE_COLLECTION = "pico_devices"  # Podemos usar a mesma coleção
FIRESTORE_DOCUMENT   = "joystick_01"    # Novo nome de documento!
...
def on_message(client, userdata, msg):
    ...
    try:
        # Extrai a coordenada do tópico (ex: "x" de "joystick/x")
...
def main():
    # Usamos a Callback API v1 para evitar o DeprecationWarning
    ...
    print("Iniciando loop do cliente MQTT para o Joystick...")
    client.loop_forever()
